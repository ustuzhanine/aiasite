...
export default function FigmaMobileCanvas() {
  ...
  const [scale, setScale] = useState(window.innerWidth / 781); // 781px - ширина мобильного макета Figma

  useEffect(() => {
    const handleResize = () => {
      setScale(window.innerWidth / 781);
    };
  ...
  return (
    <div className="relative w-full min-h-screen bg-white" data-name="mobile" data-node-id="48:160" style={{ maxWidth: '100vw', overflowX: 'hidden' }}>
      <div className="absolute bg-white h-[12024px] left-0 top-[1270px] w-full z-0" data-node-id="52:324" />
      <div className="absolute blur-[15.05px] filter h-[1001px] left-[-50px] rounded-[5px] top-[269px] w-[881px] z-10" data-name="Снимок экрана 2025-09-25 в 21.53.07 1" data-node-id="48:163">
      ...
      <div className="absolute bg-[#071a31] h-[923px] left-[-5px] top-[13254px] w-[786px]" data-node-id="48:165" />
      <div className="absolute flex flex-col font-['Montserrat:Medium',_sans-serif] font-medium h-[46px] justify-center leading-[0] left-[135px] text-[#071a31] text-[50px] top-[1383px] translate-y-[-50%] w-[219px] z-20" data-node-id="48:169">
        <p className="leading-[normal]">О нас</p>
      </div>
      <div className="absolute flex flex-col font-['Montserrat:Medium',_sans-serif] font-medium h-[46px] justify-center leading-[0] text-[#071a31] text-[50px] top-[3455px] translate-y-[-50%] w-[468px]" data-node-id="48:170" style={{ left: "calc(50% - 255.5px)" }}>
        <p className="leading-[normal]">Наши услуги</p>
      </div>
      <div className="absolute flex flex-col font-['Montserrat:Medium',_sans-serif] font-medium h-[46px] justify-center leading-[0] text-[#071a31] text-[50px] top-[5638px] translate-y-[-50%] w-[468px]" data-node-id="48:171" style={{ left: "calc(50% - 255.5px)" }}>
        <p className="leading-[normal]">Наши проекты</p>
      </div>
      <p className="absolute font-['Montserrat:Medium',_sans-serif] font-medium h-[159px] leading-[normal] text-[#071a31] text-[50px] top-[8745px] w-[603px]" data-node-id="48:172" style={{ left: "calc(50% - 264.5px)" }}>
      ...
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[87px] leading-[59px] text-white text-[50px] top-[13413px] w-[625px]" data-node-id="48:176" style={{ left: "calc(50% - 261.5px)" }}>
        +7 (495) 123-47-05
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[108px] leading-[59px] text-white text-[50px] top-[13605px] w-[575px]" data-node-id="48:177" style={{ left: "calc(50% - 264.5px)" }}>
        in@aiagency.ru
      </p>
      <p className="absolute font-['Montserrat:Bold',_sans-serif] font-bold h-[71px] leading-[59px] text-white text-[30px] top-[13534px] w-[317px]" data-node-id="48:180" style={{ left: "calc(50% - 258.5px)" }}>
        электронная почта
      </p>
      ...
      <div className="[text-shadow:rgba(0,0,0,0.25)_4px_4px_8px] absolute flex flex-col font-['Montserrat:SemiBold',_sans-serif] font-semibold h-[177px] justify-center leading-[0] left-[92px] text-white text-[50px] top-[438px] w-[433px] z-20" data-node-id="48:185">
        <p className="leading-[44px]">Агентство Искусственного Интеллекта</p>
      </div>
      <p className="[text-shadow:rgba(0,0,0,0.25)_4px_4px_8px] absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[108px] leading-[42px] left-[101px] text-white text-[36px] top-[615px] w-[589px] z-20" data-node-id="48:186">
      ...
      <div className="absolute contents left-[39px] top-[1074px]" data-node-id="48:187">
        ...
        <div className="absolute flex flex-col font-['Montserrat:Regular',_sans-serif] font-normal h-[46px] justify-center leading-[0] left-[196.0889892578125px] text-white text-[40px] top-[1096px] translate-x-[-50%] translate-y-[-50%] w-[398.82196044921875px]" data-node-id="48:189">
      ...
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[293px] leading-[normal] left-[135px] text-white text-[31px] top-[3804px] w-[527px]" data-node-id="48:193">
      ...
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[293px] leading-[normal] left-[135px] text-white text-[31px] top-[4428px] w-[527px]" data-node-id="52:326">
      ...
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[293px] leading-[normal] left-[135px] text-white text-[31px] top-[5081px] w-[527px]" data-node-id="52:329">
      ...
      <p className="absolute font-['Montserrat:Medium',_sans-serif] font-medium h-[107px] leading-[normal] left-[135px] text-white text-[34px] top-[3647px] w-[527px]" data-node-id="48:196">
        Корпоративное обучение искусственному интеллекту
      </p>
      <p className="absolute font-['Montserrat:Medium',_sans-serif] font-medium h-[107px] leading-[normal] left-[135px] text-white text-[34px] top-[4281px] w-[527px]" data-node-id="52:327">
        Стратегия внедрения ИИ
      </p>
      <p className="absolute font-['Montserrat:Medium',_sans-serif] font-medium h-[107px] leading-[normal] left-[135px] text-white text-[34px] top-[4934px] w-[527px]" data-node-id="52:330">
        Разработка ИИ-решений
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[179px] text-white text-[100px] text-center top-[2608px] translate-x-[-50%] w-[193px]" data-node-id="48:200">
        7
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[470px] text-white text-[100px] text-center top-[2608px] translate-x-[-50%] w-[234px]" data-node-id="48:201">
        61
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[751px] text-white text-[100px] text-center top-[2608px] translate-x-[-50%] w-[282px]" data-node-id="48:202">
        120+
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[1059px] text-white text-[100px] text-center top-[2608px] translate-x-[-50%] w-[280px]" data-node-id="48:203">
        15
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[1388px] text-white text-[100px] text-center top-[2608px] translate-x-[-50%] w-[281px]" data-node-id="48:204">
        220
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[136px] text-white text-[30px] text-center top-[2754px] translate-x-[-50%] w-[279px]" data-node-id="48:205">
        лет экспертизы в области ИИ
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[470px] text-white text-[30px] text-center top-[2754px] translate-x-[-50%] w-[260px]" data-node-id="48:206">
        реализованный проект
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[777px] text-white text-[30px] text-center top-[2754px] translate-x-[-50%] w-[234px]" data-node-id="48:207">
        научных проектов
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[1047px] text-white text-[30px] text-center top-[2754px] translate-x-[-50%] w-[304px]" data-node-id="48:208">
        государственных стандартов по ИИ
      </p>
      <p className="absolute font-['Montserrat:Regular',_sans-serif] font-normal h-[122px] leading-[normal] left-[1389px] text-white text-[30px] text-center top-[2754px] translate-x-[-50%] w-[279px]" data-node-id="48:209">
      ...
      <div className="absolute h-[200px] left-[50px] top-[3070px] w-[680px]" data-name="Логотипы партнёров" data-node-id="partners-section-mobile">
      ...
      <div className="absolute bg-[#071a31] h-[1113px] left-[-19px] rounded-[19px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[8733px] w-[91px]" data-node-id="48:166" />
